...
- **Estimated duration:** 20 min
- **Prerequisites:** MATH-G4-NB-02
- **Vocabulary:** جوڑ (sum), ہاتھ لے جانا (carry), جمع (addition)
...
- **Vocabulary:** ہاتھ لے جانا (carry in multiplication)
- **Examples:** ۳۷ × ۴ = ۱۴۸.
...
| Date | Change | Author |
| --- | --- | --- |
| 2026-07-21 | Grade 4 Mathematics pilot curriculum authored: 8 units, 31 lessons + 8 revisions + 1 summative, competency/mastery model, 15-entry misconception library, graduated hint hierarchy, revision/spacing model, mentor-mediated summative, content inventory. Extends live FR-01. NCP-aligned re-expression (non-verbatim), authored-original content. | Content authoring (WS4) |
| 2026-07-22 | Restored from session authoring (working-tree loss recovery). Content unchanged. | Docs restore |
